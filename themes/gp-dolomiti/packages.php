		...
		<section class="subsection">
			...
			<div class="l-package__summary">
				<ul class="package__summary cf">
					...
					<li class="media"><div class="media__img"><i class="fa fa-fw fa-2x fa-glass"></i></div><div class="media__bd"><? _e("<!--:en-->4 Dinner events<!--:--><!--:de-->4 Dinner Events<!--:--><!--:it-->4 Dinner Events<!--:--><!--:fr-->4 Dinner Events<!--:-->"); ?></div></li>
