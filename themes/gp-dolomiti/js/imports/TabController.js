	...
	var TabController = {
		...
		onclick: function(e)
		{
			...
			$.each(tabEls, function(i, el)
			{
				...
				if($el.hasClass("tabs__nav-item--active"))
				{
					$el.removeClass("tabs__nav-item--active").addClass("tabs__nav-item");
				}
				else if($el.hasClass("tabs--nested__nav-item--active"))
				{
					$el.removeClass("tabs--nested__nav-item--active").addClass("tabs--nested__nav-item");	
				}
			});
			...
			{
				parent.addClass("tabs__nav-item--active");
			}
			else if(parent.hasClass("tabs--nested__nav-item"))
			{
				parent.addClass("tabs--nested__nav-item--active");
			}
