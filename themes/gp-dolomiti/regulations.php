...
<section class="regulations">
	<div class="grid">
		...
		<ul class="space-lover">
			<li><? _e('<!--:en-->Until 60 days before event: &euro;200.-<!--:--><!--:de-->Bis 60 Tage vor Anreise: &euro;200.-<!--:--><!--:it-->Fino a 60 giorni prima del evento: &euro;200.-<!--:--><!--:fr-->60 jours avant l\'arrivée: &euro;200.-<!--:-->'); ?></li>
