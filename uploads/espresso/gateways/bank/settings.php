...
function event_espresso_bank_payment_settings() {
	...
	if (empty($bank_deposit_settings)) {
		...
		$bank_deposit_settings['iban'] = '';
		$bank_deposit_settings['swift_bic'] = '';
		...
		<table width="99%" border="0" cellspacing="5" cellpadding="5">
			<tr>
				...
				<td valign="top"><ul>
						...
						<li>
							<label for="iban">
								<?php _e('IBAN', 'event_espresso'); ?>
							</label>
							<input type="text" name="iban" size="34" value="<?php echo trim($bank_deposit_settings['iban']) ?>" />
						</li>
						<li>
							<label for="swift_bic">
								<?php _e('SWIFT/BIC Code', 'event_espresso'); ?>
							</label>
							<input type="text" name="swift_bic" size="11" value="<?php echo trim($bank_deposit_settings['swift_bic']) ?>" />
						</li>
						<li>
