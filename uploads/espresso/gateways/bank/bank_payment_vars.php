...
?>
	...
	<p class="form-section">
		<?php _e('<!--:en-->By clicking "Complete Registration" I confirm that I have read and fully accept the Gran Premio Dolomiti <a href="http://granpremiodolomiti.com/en/regulations" title="View Terms and Conditions"><strong>Terms and Conditions</strong></a>.<!--:--><!--:de-->Durch Klick auf "Anmeldung abschließen" bestätige ich, dass ich die Gran Premio Dolomiti <a href="http://granpremiodolomiti.com/de/regulations" title="Teilnahmebedingungen anzeigen"><strong>Teilnahmebedingungen</strong></a> gelesen und akzeptiert habe.<!--:--><!--:it-->Cliccando su "Concludi l\'iscrizione" confermo di aver letto e accettato i <a href="http://granpremiodolomiti.com/it/regulations" title="Mostra Termini e Condizioni"><strong>Termini e Condizioni</strong></a> del Gran Premio Dolomiti.<!--:--><!--:fr-->En cliquant sur Confirmer l\'inscription, vous confirmez votre accord avec <a href="http://granpremiodolomiti.com/fr/regulations" title="Voir les Termes et Conditions"><strong>les Termes et Conditions du Gran Premio Dolomiti</strong></a>.<!--:-->'); ?>
	</p>
